...
--     Change background image to ~/.config/awesome/wallpapers/Baertling-Oradalki.jpg
--     cd ~/.config/awesome && git clone https://github.com/mokasin/apw.git (in ~/.config/awesome)
--     cd ~/.config/awesome && git clone https://github.com/copycat-killer/awesome-freedesktop.git freedesktop
--     Note, the freedesktop clone is not configured. Need to make sure I've cloned the correct branch (for 3.5.X)
--     Downloaded assault.lua from https://github.com/NuckChorris/assault/tree/master/awesomewm into ~/.config/awesome
--     Added countdown (to rc.lua) from https://awesomewm.org/recipes/countdown/
...
-- Volume using APW (http://awesome.naquadah.org/wiki/Volume_control_for_PulseAudio)
local APW = require("apw/widget")

-- Battery indicator Assault https://github.com/NuckChorris/assault/tree/master/awesomewm
local assault = require('assault')

-- Load Debian menu entries
require("debian.menu")

-- Freedesktop menus. See github.com/copycat-killer/awesome-freedesktop
...
-- System default is in /usr/share/awesome/themes/default
beautiful.init(awful.util.getdir("config") .. "/themes/default/theme.lua")

-- {{{ Make sure language is set to my keyboard (JN)
os.execute("setxkbmap se")
-- }}}

-- This is used later as the default terminal and editor to run.
terminal = "x-terminal-emulator"
terminalx = "/home/nylander/bin/termx"
...
-- {{{ Wallpaper
-- In ~/.config/awesome/wallpapers
beautiful.wallpaper = awful.util.get_configuration_dir() .. "wallpapers/Baertling-Oradalki.jpg"
...
for s = 1, screen.count() do
    ...
    -- xrun("Bluetooth Applet", "bluetooth-applet") -- Test to see if blueman-applet self organizes it self
...
globalkeys = awful.util.table.join(
    ...
    -- Standard program
    awful.key({ modkey,           }, "Return", function () awful.util.spawn(terminalx) end),
    awful.key({ modkey,           }, "x", function () awful.util.spawn(terminal) end),        -- JN
    awful.key({ modkey,           }, "w", function () awful.util.spawn("chromium-browser") end), -- JN
    awful.key({ modkey,           }, "v", function () awful.util.spawn("gvim") end),          -- JN
...
clientkeys = awful.util.table.join(
    ...
    awful.key({ modkey,           }, "Down",
        function (c)
            -- c.maximized_horizontal = not c.maximized_horizontal -- JN
