...
-- https://github.com/awesomeWM/awesome#debian-based.
-- This will install files in /usr/local/etc/xdg/awesome/,
-- /usr/local/share/awesome/, /usr/local/share/doc/awesome/, /usr/local/share/man*.
-- The default user rc.lua was modified from awesomerc.lua and placed in ~/.config/awesome.
-- The default theme.lua was modified from /usr/local/share/awesome/themes/default/theme.lua
-- and placed in ~/.config/awesome
--
--   $ cd ~/src/
--   $ git clone https://github.com/awesomeWM/awesome.git && cd awesome
--   $ make package
--   $ cd build && sudo apt install ./*.deb
...
--     Note: not pleased with the scaling of the image using a call to feh.
...
-- {{{ Wallpaper
-- JN: brute force fill my wallpaper image. Requires feh.
...
awful.keyboard.append_global_keybindings({
    ...
    -- JN: Keybindings for my software
    -- awful.key({ modkey }, "x",
    --           function ()
    --               awful.prompt.run {
    --                 prompt       = "Run Lua code: ",
